...
$(document).ready(function () {
    $("#formBuscadorContacto").on("submit",
        function (e) {
            e.preventDefault();
            EjecutarBusqueda();
        });
    ...
    $(".body-content").on("click",
        ...
        function () {
            ...
            LoadViewWithModel(DetalleContacto, data);
        });

    $("#btnRegistrar").on("click",
        function () {
            LoadViewWithModel(DetalleContacto, { Id: 0 });
        });
...
function EjecutarBusqueda() {
    var request = $("#formBuscadorContacto").FormAsJSON();
    GetResponse(BuscarContacto,
        request,
        function (out) {
            if (out.Success) {
                if (out.Data != undefined) {
                    ...
                    table = $("#gridBuscador").DataTable({
                        ...
                        destroy: true,
                        columns: columnsGrid,
                        // Footer de la tabla de lista de Contacto
                        language: {
